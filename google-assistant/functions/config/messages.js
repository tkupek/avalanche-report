const messages = {
    'en': {
        translation: {
            'WELCOME': 'Welcome to avalance forecast. What region are you interested in? Tyrol, South Tyrol or Trentino?',
            ...
            'FORECAST_LEVEL_DOUBLE': 'The danger level below x meter is {{0}}, over x meter it is {{1}}.',
