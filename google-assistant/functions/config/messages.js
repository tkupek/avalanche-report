const messages = {
    'en': {
        translation: {
            ...
            'DANGER_LEVEL_INTRO_5': 'Danger level 5, very high, stands for an extraordinary avalanche situation. Check the card for a detailed explanation. Do you want to inform about level 1?',
            'DANGER_LEVEL_INTRO_4': 'Danger level 4, high, stands for a very critical avalanche situation. Check the card for a detailed explanation. Do you want to check level 5?',
            'DANGER_LEVEL_INTRO_3': 'Danger level 3, considerable, stands for a critical avalanche situation. Check the card for a detailed explanation. Do you want to learn about level 4?',
            'DANGER_LEVEL_INTRO_2': 'Danger level 2, moderate, stands for mostly favorable avalanche situation. Check the card for a detailed explanation. Do you want information about level 3?',
            'DANGER_LEVEL_INTRO_1': 'Danger level 1, low, stands for a generally favourable avalanche situation. Check the card for a detailed explanation. Do you want to see level 2?',
            ...
            'FORECAST_CARD_TITLE': 'Avalanche forecast {{0}} valid until {{1}}',
